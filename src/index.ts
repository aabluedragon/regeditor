...
export { regKeyResolvePath, regKeyPathIs64Bit, regKeyResolveShortcutAndGetParts, regKeyResolveBitsView, regGetSystemSoftwareKey, getRegOptsBits, isWine32Bit, isWindows32Bit, resolvePosixFilePathWithEnvVarsAndTilde } from './utils';
