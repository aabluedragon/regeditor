...
export { regKeyResolvePath, regKeyPathIs64Bit, regKeyResolveShortcutAndGetParts, regKeyResolveBitsView, regGetSystemSoftwareKey, getRegOptsBits, isWine32Bit, isWindows32Bit, resolvePosixFilePathWithEnvVarsAndTilde, getWinePrefixPath, convertWinToWinePathOnNonWindows } from './utils';
